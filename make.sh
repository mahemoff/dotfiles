...
files="bash_profile vimrc tmux.conf vim inputrc editrc bash_before bash_after bash_tmux myclirc tigrc irbrc toprc"    # list of (dot)files to symlink in homedir
